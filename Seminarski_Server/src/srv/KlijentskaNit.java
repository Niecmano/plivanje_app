                ...
                switch (req.getOp()) {
                    ...
                    case IZMENI_PRIJAVU:
                        try {
                            ...
                            Object[] niz = (Object[]) req.getArgum();
                            Object[] ls = {niz[1],niz[2]};
                            so.sablonIzvrsavanja((EvidencijaPrijave) niz[0], ls);
                            o = new Odgovor(null, null);
                        } catch (Exception e) {
                            o = new Odgovor(null, e);
                        }
                    ...
                    case DODAJ_PRIJAVU:
                        try {
                            ...
                            Object[] niz = (Object[]) req.getArgum();
                            so.sablonIzvrsavanja((EvidencijaPrijave) niz[0], niz[1]);
                            o = new Odgovor(null, null);
                        } catch (Exception e) {
                            o = new Odgovor(null, e);
                        }
                    ...
                    case VRATI_STAVKE:
                        try {
                            SOVratiListuStavkiEvidencije so = new SOVratiListuStavkiEvidencije();
                            so.sablonIzvrsavanja(new StavkaEvidencijePrijave((EvidencijaPrijave) req.getArgum()), false);
